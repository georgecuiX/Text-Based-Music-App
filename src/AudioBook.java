...
public class AudioBook extends AudioContent
{
    ...
    public void play()
    {
        // Set the string and audio file and call the play() method in superclass AudioContent
    ...
    {
        // Check to see if the audio content properties are equal followed by the audiobook specific properties
        AudioBook aBook = (AudioBook) other;
        return super.equals(other) && author.equals(aBook.author) && narrator.equals(aBook.narrator);
    }
